...
public class RepurchaseOptionalPO extends TestStepBase<TestResultInfo> {
    private static Logger LOG = LoggerFactory.getLogger(RepurchaseOptionalPO.class);
     ...
     */
    public RepurchaseOptionalPO(String title, SoivTestBase soivTestBase, CustomerInfo customerInfo,
    ...
    public TestResultInfo execute() {
        ...
        tSpec.setJsonFileName("AddOptionalPOonBasic.json");
        Steps.PROTOCOLS.businessLogicEOC.addOptionalPOonBasicPO("Provision : Re Purchase - Optional PO on Basic PO : "+customerInfo.getCustomerId(), soivTestBase, customerInfo, tSpec, resultInfo).run();
    ...
    public RepurchaseOptionalPO setSoivTestBase(SoivTestBase soivTestBase) {
        this.soivTestBase = soivTestBase;
        return this;
    }
    ...
    public RepurchaseOptionalPO setCustomerInfo(CustomerInfo customerInfo) {
        this.customerInfo = customerInfo;
        return this;
    }
    ...
    public RepurchaseOptionalPO setTransactionSpec(TransactionSpecification tSpec) {
        this.tSpec = tSpec;
        return this;
    }

    public RepurchaseOptionalPO setName(String name) {
        setTitle(name);
        return this;
    }
