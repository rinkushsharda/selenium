...
public class GetResources extends TestStepBase<TestResultInfo> {
    private static Logger LOG = LoggerFactory.getLogger(GetResources.class);
    ...
    public GetResources(String title, SoivTestBase soivTestBase, CustomerInfo customerInfo, TransactionSpecification tSpec, TestResultInfo resultInfo) {
        super(title);
    ...
    public TestResultInfo execute() {
        ...
        resultInfo = Steps.PROTOCOLS.eoc
                .sendEocRequest("GET Resources", resultInfo, HttpMethod.GET, 200,
    ...
    public GetResources setSoivTestBase(SoivTestBase soivTestBase) {
        this.soivTestBase = soivTestBase;
        return this;
    }
