...
public class CsRaw extends TestStepBase<TestResultInfo> {
    ...
    public CsRaw(String title, TestResultInfo resultInfo, HttpMethod httpMethod, int statusCode, String uri,
                 String body) {
        super(title);
    ...
    public TestResultInfo execute() {
        ...
        HttpResponse response = sendCsRequest(body, uri, statusCode, httpMethod);
        resultInfo.setResult(response);
        return resultInfo;
    }

    private HttpResponse sendCsRequest(String body, String uri, int expectedStatusCode, HttpMethod httpMethod) {
    ...
    public CsRaw setSoivTestBase(SoivTestBase soivTestBase) {
