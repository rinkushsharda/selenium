...
public class GetPoStatusBSCS extends TestStepBase<TestResultInfo> {
    private static Logger LOG = LoggerFactory.getLogger(GetPoStatusBSCS.class);
    ...
    public GetPoStatusBSCS(String title, SoivTestBase soivTestBase, CustomerInfo customerInfo, TransactionSpecification tSpec, TestResultInfo resultInfo) {
        super(title);
    ...
    public GetPoStatusBSCS setSoivTestBase(SoivTestBase soivTestBase) {
        this.soivTestBase = soivTestBase;
        return this;
    }
