...
public class OnlineCip extends TestStepBase<TestResultInfo>{
    ...
    public OnlineCip(String title, SoivTestBase soivTestBase, TestResultInfo resultInfo, CustomerInfo customerInfo, TransactionSpecification tSpec) {
        super(title);
    ...
    public OnlineCip setSoivTestBase(SoivTestBase soivTestBase) {
        this.soivTestBase = soivTestBase;
        return this;
    }
