...
public class CipIpSimulatorRaw extends TestStepBase<TestResultInfo> {
    ...
    public CipIpSimulatorRaw(String title, TestResultInfo resultInfo, HttpMethod httpMethod, int statusCode, String uri) {
        super(title);
    ...
    public CipIpSimulatorRaw(String title, TestResultInfo resultInfo, HttpMethod httpMethod, int statusCode, String uri, String body) {
        super(title);
        this.resultInfo = resultInfo;
        this.httpMethod = httpMethod;
        this.statusCode = statusCode;
    ...
    public TestResultInfo execute() {
        ...
        HttpResponse response = sendGYRequest(body, uri, statusCode, httpMethod);
        resultInfo.setResult(response);
        return resultInfo;
    }

    private HttpResponse sendGYRequest(String body, String uri, int expectedStatusCode, HttpMethod httpMethod) {
        ...
        if (httpMethod.equals(HttpMethod.GET)) {
            ...
            httpRequestBuilder = TextHttpRequestBuilder.newTextHttpRequestBuilder()
                    ...
                    .setHttpHeaderValue("text/html").back()
                    .setUri(newUri(uri))
                    .setBody(body);
            //@formatter:on
        }
        ...
        Jive.queue(ClientHandle.HTTP_CLIENT_SIMULATOR.name(), transaction);
    ...
    public CipIpSimulatorRaw setSoivTestBase(SoivTestBase soivTestBase) {
