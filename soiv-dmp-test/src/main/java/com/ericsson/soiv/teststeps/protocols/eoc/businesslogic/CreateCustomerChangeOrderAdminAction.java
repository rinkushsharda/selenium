...
public class CreateCustomerChangeOrderAdminAction extends TestStepBase<TestResultInfo> {
    private static Logger LOG = LoggerFactory.getLogger(CreateCustomerChangeOrderAdminAction.class);
     ...
     */
    public CreateCustomerChangeOrderAdminAction(String title, SoivTestBase soivTestBase, CustomerInfo customerInfo,
    ...
    public TestResultInfo execute() {
        ...
        String body = RawMessages.getBodyFromJsonFilePlacedInTestStep(this.getClass().getName(), "protocols/eoc",
                "CreateCustomerChangeOrderAdminAction.json");
        ...
        body = RawMessages.replaceVal(body, "childOf", tSpec.getActionCode());
    ...
    public CreateCustomerChangeOrderAdminAction setSoivTestBase(SoivTestBase soivTestBase) {
        this.soivTestBase = soivTestBase;
        return this;
    }
