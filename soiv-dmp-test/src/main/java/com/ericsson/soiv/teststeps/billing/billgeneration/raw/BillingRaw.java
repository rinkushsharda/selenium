...
public class BillingRaw extends TestStepBase<TestResultInfo> {
    ...
    public BillingRaw(String title, TestResultInfo resultInfo, HttpMethod httpMethod, int statusCode, String uri) {
        super(title);
    ...
    public BillingRaw(String title, TestResultInfo resultInfo, HttpMethod httpMethod, int statusCode, String uri, String body) {
        super(title);
        this.resultInfo = resultInfo;
        this.httpMethod = httpMethod;
        this.statusCode = statusCode;
    ...
    public TestResultInfo execute() {
        ...
        HttpResponse response = sendInvoiceRequest(body, uri, statusCode, httpMethod);
        resultInfo.setResult(response);
        return resultInfo;
    }

    private HttpResponse sendInvoiceRequest(String body, String uri, int expectedStatusCode, HttpMethod httpMethod) {
        ...
        if (httpMethod.equals(HttpMethod.GET)) {
            ...
            httpRequestBuilder = TextHttpRequestBuilder.newTextHttpRequestBuilder()
                    ...
                    .setHttpHeaderValue("text/xml").back()
                    .setUri(newUri(uri))
                    .setBody(body);
            //@formatter:on
        }
        ...
        Jive.queue(ClientHandle.HTTP_CLIENT_BSCS.name(), transaction);
    ...
    public BillingRaw setSoivTestBase(SoivTestBase soivTestBase) {
