...
public class BscsRaw extends TestStepBase<TestResultInfo> {
    ...
    public BscsRaw(String title, TestResultInfo resultInfo, HttpMethod httpMethod, int statusCode, String uri,
                   String body) {
        super(title);
    ...
    public TestResultInfo execute() {
        ...
        HttpResponse response = sendBscsRequest(body, uri, statusCode, httpMethod);
        resultInfo.setResult(response);
        return resultInfo;
    }

    private HttpResponse sendBscsRequest(String body, String uri, int expectedStatusCode, HttpMethod httpMethod) {
    ...
    public BscsRaw setSoivTestBase(SoivTestBase soivTestBase) {
