...
public class OfflineSms extends TestStepBase<TestResultInfo> {
    ...
    public OfflineSms(String title, SoivTestBase soivTestBase, TestResultInfo resultInfo, CustomerInfo customerInfo,
    ...
    public OfflineSms setSoivTestBase(SoivTestBase soivTestBase) {
        this.soivTestBase = soivTestBase;
        return this;
    }
