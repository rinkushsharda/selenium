...
public class PrepaidPOGSMTechMSISDNWithAPNRatingWithExchange extends SoivTestBase
{
    ...
    public void prepaidPOGSMTechMSISDNWithAPNRatingWithExchange() throws IOException, InterruptedException {
