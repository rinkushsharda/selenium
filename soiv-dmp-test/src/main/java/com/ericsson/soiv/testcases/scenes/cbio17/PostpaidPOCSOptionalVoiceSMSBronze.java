...
public class PostpaidPOCSOptionalVoiceSMSBronze extends SoivTestBase {
    ...
    @Description("TS760 - Postpaid_PO_CS_Optional_Voice_SMS_Bronze")
    public void postpaidPoCsOptionalVoiceSmsBronze() throws InterruptedException, IOException {
