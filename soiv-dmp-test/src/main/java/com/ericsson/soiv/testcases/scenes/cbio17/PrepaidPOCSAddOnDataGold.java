...
//Created By ZEAHDCE 3-May-2019
@Fixture(SoivFixture.class)
public class PrepaidPOCSAddOnDataGold extends SoivTestBase {
    ...
    @Description("TS708 - prepaid PO CS AddOn Data Gold")
    public void prepaidPoCsAddOnDataGold() throws IOException {
        ...
        Steps.PROVISION.eoc.createShoppingCart("Provision : Create Shopping Cart for Personalize usage", this,
                customerInfo, ts, resultInfo).run();
        Steps.PROTOCOLS.businessLogicEOC.getShoppingCart("Protocol : Get Shopping Cart for Personalize usage", this,
                customerInfo, ts, resultInfo).run();
        ...
        Steps.PROTOCOLS.businessLogicEOC
                .updatePooi("Update For Personalization of the OneTimeCharge ", this, customerInfo, ts, resultInfo)
                .run();
    ...
    public static JSONObject oneTimeChargeChange(String json, String searchValue, String insertValue)
        ...
        JSONArray productPrice = product.getJSONArray("productPrice"); // product price json
        JSONObject productPrice1 = productPrice.getJSONObject(0);

        JSONArray characteristics = productPrice1.getJSONArray("characteristics");
        ...
        productPrice1.put("characteristics", characteristics);
        productPrice.put(1, productPrice1);
    ...
    private String getOneTimeCharge(String response) {
        ...
        JSONArray treeParameterSetInformationList = new JSONObject(response).getJSONArray("offerInformation")
