...
//Created By ZMUKMAN 03-July-2019

@Fixture(SoivFixture.class)
public class PostpaidBasicOptionalExchangeIPResources extends SoivTestBase {
    ...
    @Description("PostpaidBasicOptionalExchangeResources UC07 BUC8BB")
    public void postpaidBasicOptionalExchangeIPResources() throws IOException, InterruptedException {
        ...
        customerInfo.setIpv4(String.valueOf(customerInfo.getresource().toString()));
