...
public class PrepaidPOISDNTechIsdnOlidIpAndVoiceRating extends SoivTestBase
{
    ...
    public void prepaidPOISDNTechIsdnOlidIpAndVoiceRating() throws IOException, SQLException, InterruptedException
    {
        ...
        productOfferings.put("optional", businessCache.get("PO.ID_OPTIONAL_VOICE_RATING"));
        ts.setProductOfferingIds(productOfferings);
        Steps.PROTOCOLS.businessLogicEOC
                .getShoppingCart("Protocol : Get Shopping Cart To get Basic POOI", this, customerInfo, ts, resultInfo)
                .run();
        ...
        Steps.CHARGING_ONLINE.simulator
                .onlineCip("Protocol : Data call for IAID number", this, resultInfo, customerInfo, ts)
                .run();
