...
public class LateCallCDRProcessing extends SoivTestBase
{
    ...
    @Description ("Late call CDR Processing When Exchanged Resource is under Grace Period 22B_1")
    public void lateCallCDRProcessing() throws IOException
    {
        ...
        String msisdnOriginal = customerInfo.getMsisdn();
        /***************************
        ...
        /* ===Usage for GSM MSISDN for the removed MSISDN Resource==== */
        customerInfo.setMsisdn(msisdnOriginal);
        ts.setExpectedCost(businessCache.get("MSISDN.USAGE_EXPECTED_COST"));
        ts.setRatingGroup(businessCache.get("MSISDN.USAGE.RATING_GROUP"));
        Steps.CHARGING_ONLINE.simulator
                .onlineGy("Protocol : Data call for MSISDN number", this, resultInfo, customerInfo, ts)
