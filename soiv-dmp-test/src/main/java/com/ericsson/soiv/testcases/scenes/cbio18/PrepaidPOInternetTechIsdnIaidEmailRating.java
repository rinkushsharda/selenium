...
public class PrepaidPOInternetTechIsdnIaidEmailRating extends SoivTestBase
{
    ...
    public void prepaidPOInternetTechIsdnIaidEmailRating() throws IOException
    {
